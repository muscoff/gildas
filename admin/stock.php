...
<body>
    ...
    <div class="width-30 width-lx-50 width-l-60 width-m-80 width-s-90 min-height-30 menu-options padding-all-10">
        <div class="optionTitle uppercase">
            <div class="blue-text"><i class="fas fa-cogs"></i> Stock Manager</div>
        </div>
        ...
        <div class="padding-all-10">
            <form onsubmit="onSubmit(event)">
                <div><input type="text" placeholder="Title" name="title" id="title" /></div><br />

                <div><input type="text" placeholder="Price" name="price" id="price" /></div><br />

                <div><input type="number" min="1" placeholder="Quantity" name="qty" id="qty" /></div><br />

                <div><input type="text" placeholder="Barcode" id="barcode" name="barcode" /></div><br />

                <div class="font-allerRg">
                    <label for="">Upload product Image</label>
                    <input type="file" id="file" name="img" class="input" />
                </div><br />

                <div><input type="submit" value="Add Product" /></div><br />
            </form>
        </div>
