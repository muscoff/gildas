...
<head>
    ...
    <link rel="stylesheet" href="<?=url;?>css/admin/report.css">
...
<body>
    ...
    <div id="holder" class="width-30 width-lx-50 width-l-60 width-m-80 width-s-90 min-height-30 menu-options padding-all-10">
        <div class="optionTitle uppercase">
            <div class="blue-text"><i class="fas fa-clipboard-list"></i> General Report</div>
        </div>
        ...
        <div id="arrow" class="width-100 height-10 flex-column justify-content-center align-items-center">
            <div class="center-text font-20">
                <span class="padding-right-10" onclick="backReport()"><i class="fas fa-arrow-left red-text blue-hover padding-all-10" id="back"></i></span>
                <span class="padding-left-10" onclick="moveReport()"><i class="fas fa-arrow-right blue-text green-hover padding-all-10" id="forward"></i></span>
            </div>
        </div>
    </div>
    ...
    <script>
        var user_role = "<?=$_SESSION['user'];?>";
    </script>
    <script src="<?=url;?>js/users/sidemenu.js"></script>
    <script src="<?=url;?>js/users/report.js"></script>
</body>
</html>
